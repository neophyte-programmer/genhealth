  ...
  return (
      <main>
        ...
        <form className='flex flex-col justify-center items-center w-full h-full space-y-3'>
         ...
         <text className='text-gray-500  text-[12px]'>Enter your account details to enter our platform.</text>
          ...
          <button className='flex flex-row justify-evenly bg-white border border-gray-400 rounded-md  gap-x-2 mb-2 w-[50]> */}
           <span class="icon-[flat-color-icons--google]">Sign In With Facebook</span></button>
          </div>
      <input type="email" placeholder="Enter your email" className="border border-gray-400 rounded-md p-2 mb-4 w-[50%]" />
        ...
        // < className='w-[50%] relative'>
          ...
          <span className="text-grey-400" > specifically for all the encoded data in healthcare.</span>
          </div>
